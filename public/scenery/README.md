...
- Ground and runway use one diffuse sample per pixel, mipmaps and 4× anisotropy. The runway also samples its 2048 × 256 paint mask. Normal/roughness maps and multi-sample triplanar cliff shaders are not loaded.
