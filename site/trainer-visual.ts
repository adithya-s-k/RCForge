/** Original socket orientation drawing, not an electrical pinout.
 * Contact roles must be established for the user's actual FS-i6 breakout.
...
<!-- Enlargement is deliberately separate from all electrical wires. -->
...
<rect x="206" y="626" width="8" height="9" fill="#111419" stroke="#737c89"/>
...
<text x="227" y="709" class="small" text-anchor="middle">Orientation only · contacts unassigned</text>
...
<text x="462" y="250" class="small">Socket front ≠ plug solder side. Do not guess a contact.</text>
...
<text x="40" y="947" font-size="13" fill="#737c89">Original schematic / FS-i6 rear reference / not a cable pinout or hardware-tested installation</text>
</svg>\n`;
}
